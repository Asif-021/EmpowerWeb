      ...
      chrome.scripting.executeScript({
        ...
        func: () => {
          ...
          if (existingDiv) {
            ...
            const scale = 2; // Magnification level
            div.style.position = "absolute";
            ...
            document.addEventListener("mousemove", (e) => {
              ...
              div.style.left = `${cursorX - size / 2}px`;
              div.style.top = `${cursorY - size / 2}px`;
              div.style.backgroundPosition = `-${cursorX * scale - size / 2}px -${cursorY * scale - size / 2}px`;
